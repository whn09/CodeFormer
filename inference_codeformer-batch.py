...
#         end2 = time.time()
#         print('align face time:', end2-end1)
...
#         end3 = time.time()
#         print('restore face time:', end3-end2)
...
#         end4 = time.time()
#         print('paste back time:', end4-end3)
...
#         end5 = time.time()
#         print('save faces time:', end5-end4)
...
#         end6 = time.time()
#         print('save restored img time:', end6-end5)
